    ...
    public class CartillaAtencionController : Controller
    {
        ...
        public JsonResult guardarCartillaAtencion(GEL_CartillaAtencion cartilla)
        {
         ...
         public void EnviarCorreo(GEL_CartillaAtencion cartilla)
         {
             ...
             String mailTo = Empleado.obtenerMailEmpleado(cartilla.id_empleado);
             String codCartilla = CartillaAtencion.obtenerCodigoCartilla();
             String cliente = Cliente.obtenerNombre(cartilla.id_cliente);
             String paciente = Paciente.obtenerNombre(cartilla.id_paciente);
             String raza = Paciente.obtenerRaza(cartilla.id_paciente);
             String tipo = Paciente.obtenerTipo(cartilla.id_paciente);
